...
OUT_IMG     = r"C:\Users\Juanshots\Desktop\PROYECTO_INV_TEO\DATOS LIMPIOS\ENTRADA Y SALIDA MENSUAL\PREDICCIONES\resultados_visualizacion.png"

# ── 1. CARGAR REAL DESDE PARQUETS 2025 ────────────────────────────────────────
archivos_2025 = sorted(glob.glob(f"{PARQUET_DIR}\\2025-*-entradas.parquet"))
