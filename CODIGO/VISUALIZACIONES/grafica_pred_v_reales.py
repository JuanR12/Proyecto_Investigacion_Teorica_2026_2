...
# Ruta al CSV de predicciones — ajustar el nombre de archivo si es necesario
...
plt.tight_layout()
plt.savefig(RUTA_FIGURAS / "comparativa_2025_pred_real.png", dpi=150, bbox_inches="tight")
plt.show()
print(f"Figura guardada en {RUTA_FIGURAS / 'comparativa_2025_pred_real.png'}")