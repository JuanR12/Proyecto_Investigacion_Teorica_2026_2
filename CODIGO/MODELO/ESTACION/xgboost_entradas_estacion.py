...
plt.tight_layout()
plt.savefig(RUTA_FIGURAS / f"prediccion_entradas_{STATION_ID}.png", dpi=150, bbox_inches="tight")
plt.show()
print(f"Figura guardada en {RUTA_FIGURAS / f'prediccion_entradas_{STATION_ID}.png'}")
